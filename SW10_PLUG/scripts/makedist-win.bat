...
if %1 == 1 (echo Making SW10_PLUG Windows DEMO VERSION distribution ...) else (echo Making SW10_PLUG Windows FULL VERSION distribution ...)
...
REM - msbuild SW10_PLUG-app.vcxproj /p:configuration=release /p:platform=win32
...
REM --wraptool sign --verbose --account XXXXX --wcguid XXXXX --keyfile XXXXX.p12 --keypassword XXXXX --in .\build-win\aax\bin\SW10_PLUG.aaxplugin\Contents\Win32\SW10_PLUG.aaxplugin --out .\build-win\aax\bin\SW10_PLUG.aaxplugin\Contents\Win32\SW10_PLUG.aaxplugin
REM --wraptool sign --verbose --account XXXXX --wcguid XXXXX --keyfile XXXXX.p12 --keypassword XXXXX --in .\build-win\aax\bin\SW10_PLUG.aaxplugin\Contents\x64\SW10_PLUG.aaxplugin --out .\build-win\aax\bin\SW10_PLUG.aaxplugin\Contents\x64\SW10_PLUG.aaxplugin
...
:32-Bit-is
"%ProgramFiles%\Inno Setup 5\iscc" /Q /cc ".\installer\SW10_PLUG.iss"
goto END-is

:64-Bit-is
"%ProgramFiles(x86)%\Inno Setup 5\iscc" /Q /cc ".\installer\SW10_PLUG.iss"
goto END-is
...
REM -if %1 == 1 (
REM -copy ".\installer\SW10_PLUG Installer.exe" ".\installer\SW10_PLUG Demo Installer.exe"
REM -del ".\installer\SW10_PLUG Installer.exe"
REM -)
