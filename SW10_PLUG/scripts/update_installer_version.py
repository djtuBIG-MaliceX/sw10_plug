...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SW10_PLUG Demo Installer\n"
      else:
        line="OutputBaseFilename=SW10_PLUG Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SW10_PLUG Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SW10_PLUG installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SW10_PLUG Demo installer\n"
     else:
       line="SetupWindowTitle=SW10_PLUG installer\n"
